...
from backend.customer_registration.schemas import (
    CustomerIn,
    CustomerEditIn,
    CustomerOut,
    BusinessDescriptionGenerateIn,
)
from backend.utils import get_db_pool, DB_SCHEMA, is_business_description_ai_configured
from backend.campaign.campaign import insert_campaign_capture_for_public_create
from backend.security.rbac import require_permission, get_employee_payload_if_bearer, assert_platform_permission
